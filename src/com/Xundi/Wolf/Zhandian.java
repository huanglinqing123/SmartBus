...
public class Zhandian extends Activity {
	...
	private String keyname[] = new String[1024];
				...
				try {
					...
					if (jsonObject.getInt("error_code") == 0) {//
						...
						for (int i = 0; i < array.length(); i=i+2) {
							...
							keyname[i] = jsonObject2.getString("key_name");
							buffer.append(name + "\n");
						...
						Toast.makeText(Zhandian.this, "对不起暂无您要查询的信息", 0).show();
					}
